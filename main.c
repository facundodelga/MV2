...
void cargaMV(TMV *mv, char *args[],int *numInstrucciones,char *version){
    ...
    if(archBinario){
        ...
        if(strcmp(header,"VMX23") == 0){
            ...
            fread(&tamanio,sizeof(unsigned short int),1,archBinario); //Leo el tama�o del codigo y asigno al CS
            ...
            if(*version == 2){
                ...
                fread(&tamanio,sizeof(unsigned short int),1,archBinario); //Leo el tama�o del KS
                ...
                fread(&tamanio,sizeof(unsigned short int),1,archBinario); //Leo el tama�o DS
                ...
                fread(&tamanio,sizeof(unsigned short int),1,archBinario); //Leo el tama�o ES
                ...
                fread(&tamanio,sizeof(unsigned short int),1,archBinario); //Leo el tama�o SS
